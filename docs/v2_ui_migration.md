...
`public/prototypes/` 配下の静的 HTML プロトタイプで確立した方針を Rails 本体に移植する。
...
| ボタン | Bootstrap `.btn-primary` 等 | `.btn` / `.btn-block` |
...
|--------|--------|-----------|-----------|
| 1 | 結果画面 | `records#result` | `public/prototypes/result_final.html` |
| 2 | 店舗詳細 | `ramen_shops#show` | `public/prototypes/shop_final.html` |
| 3 | 接続フォーム | `records#new` | `public/prototypes/connect_final.html` |
| 4 | 近くの店舗 | `ramen_shops#near_shops` | `public/prototypes/nearby_final.html` |
| 5 | ユーザー画面 | `users#show` | `public/prototypes/user_final.html` |
