...
|--------|--------|-----------|-----------|
| 1 | 結果画面 | `records#result` | `docs/prototypes/result_final.html` |
| 2 | 店舗詳細 | `ramen_shops#show` | `docs/prototypes/shop_final.html` |
| 3 | 接続フォーム | `records#new` | `docs/prototypes/connect_final.html` |
| 4 | 近くの店舗 | `ramen_shops#near_shops` | `docs/prototypes/nearby_final.html` |
| 5 | ユーザー画面 | `users#show` | `docs/prototypes/user_final.html` |
