...
RSpec.describe Record do
  ...
  describe 'Scopes' do
    describe '.not_retired_or_connecting' do
      ...
      let!(:connecting_record) { create(:record_only_has_started_at, is_retired: false, ramen_shop: create(:ramen_shop, :many_shops)) }
      ...
      it 'includes both finished and connecting records' do
        ...
        expect(results).not_to include(retired_record, auto_retired_record, test_record)
      end
